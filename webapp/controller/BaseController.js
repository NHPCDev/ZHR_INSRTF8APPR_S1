sap.ui.define([
    ...
    function (Controller, messenger, BusyIndicator, Filter, FilterOperator, ValueState, DateFormat, Fragment, SearchField, Label, Text) {
        ...
        return Controller.extend("com.nhpc.zhrinsrtf8apprs1.controller.BaseController", {
            ...
            onComboBoxChangeRelative: function (oEvent) {
                var oViewModel = this.getModel("viewModel");
                var oSrc = oEvent.getSource(),
                    sValue = oSrc.getSelectedKey();
                ...
                if (!sValue) {
                    ...
                    oViewModel.setProperty("/RelativePopup/Relation", "");
            ...
            onComboBoxChangeFin: function (oEvent) {
                var oViewModel = this.getModel("viewModel");
                var oSrc = oEvent.getSource(),
                    sValue = oSrc.getSelectedKey();
            ...
            onDateChange: function (oEvent) {
                ...
                if (bValidDate) {
                    ...
                    oSrc.setValue(null);
                    oSrc.setValueState(ValueState.Error);
                    oSrc.setValueStateText(oResourceBundle.getText("invalidDate"));
                    messenger.error(oResourceBundle.getText("invalidDateErrorMsg"));
